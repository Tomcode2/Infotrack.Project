...
namespace Infotrack.FrequencyFinder.UI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<SearchDbContext>(options => options.UseSqlServer
                (Configuration.GetConnectionString("InfoTrackConnString"), x => x.MigrationsAssembly("Infotrack.FrequencyFinder.Data")));
